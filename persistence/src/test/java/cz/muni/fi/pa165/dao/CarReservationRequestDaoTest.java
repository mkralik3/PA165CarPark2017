...
public class CarReservationRequestDaoTest extends AbstractTestNGSpringContextTests{
	...
	public void findAllReservations(){
		...
		reservation1.setCar(car1);
                ...
                reservation1.setReservationStartDate(currentTime.plus(1, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
                reservation1.setReservationEndDate(currentTime.plus(5, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
		...
		reservation2.setCar(car1);
                ...
                reservation2.setReservationStartDate(currentTime.plus(7, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
                reservation2.setReservationEndDate(currentTime.plus(10, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
	...
	public void findAllReservationsWhichStartBetween(){
		...
		List<CarReservationRequest> reservations  = (List<CarReservationRequest>) reservationDao
                        .findAllReservationsWhichStartBetween(
                                currentTime.atZone(ZoneId.of("Europe/Paris")), 
                                currentTime.plus(4, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
		...
		List<CarReservationRequest> reservations  = (List<CarReservationRequest>) reservationDao
                        .findAllReservationsWhichEndBetween(
                                currentTime.plus(8, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")), 
                                currentTime.plus(12, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
	...
	public void findReservationById(){
		...
		reservation.setCar(car1);
                ...
                reservation.setReservationStartDate(currentTime.plus(1, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
                reservation.setReservationEndDate(currentTime.plus(5, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
	...
	public void nullReservationEndDateIsNotAllowed(){
		...
		reservation.setCar(car1);
                reservation.setUser(user);
                reservation.setCreationDate(LocalDateTime.of(2017, Month.MARCH, 20, 10, 10));
                reservation.setReservationStartDate(currentTime.plus(5, ChronoUnit.DAYS).atZone(ZoneId.of("Europe/Paris")));
